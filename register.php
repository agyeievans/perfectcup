    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#register").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    // Destination of the JS script. adduser.php makes the database connection
                    url: "adduser.php",
                    ...
                    // display the message loading while the form is being processed
                    beforeSend: function () {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; Perfect Cup 2023</p>
                </div>
            </div>
        </div>
    </footer>
